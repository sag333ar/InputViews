#
#  Be sure to run `pod spec lint InputViews.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Sagar Kothari" => "sag333ar@gmail.com" }
  # Or just: spec.author    = "Sagar Kothari"
  # spec.authors            = { "Sagar Kothari" => "sag333ar@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Sagar Kothari"
  ...
  spec.source       = { :git => "https://github.com/sag333ar/InputViews.git", :tag => "#{spec.version}" }
  ...
  spec.subspec 'CollectionInputView' do |subspec|
  ...
  spec.subspec 'PickerInputView' do |subspec|
    subspec.source_files = 'InputViews/PickerInputView/**/*.{swift}'
  end
  spec.subspec 'TableInputView' do |subspec|
    subspec.source_files = 'InputViews/TableInputView/**/*.{swift}'
  end
